...
(@project_id, 'date_enrolled', NULL, 'demographics', NULL, 2, NULL, 'Consent Information', 'text', 'Date subject signed consent', NULL, 'YYYY-MM-DD', 'date', NULL, NULL, 'soft_typed', NULL, 0, NULL, 0, NULL, NULL, NULL),
...
(@project_id, 'dob', '1', 'demographics', NULL, 8.1, NULL, NULL, 'text', 'Date of birth', NULL, NULL, 'date', NULL, NULL, 'soft_typed', NULL, 0, NULL, 0, NULL, NULL, NULL),
