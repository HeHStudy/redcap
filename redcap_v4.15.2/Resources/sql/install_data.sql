...
('DbCleanup',  'Due to some perplexing issues where things might get "out of sync" on the back-end, run some queries to fix any known issues.',  'ENABLED',  '43200',  '7200', NULL ,  'NOT YET RUN',  '0'),
('ExpireSurveys',  'For any surveys where an expiration timestamp is set, if the timestamp <= NOW, then make the survey inactive.',  'ENABLED',  '120',  '600', NULL ,  'NOT YET RUN',  '0'),
('SurveyInvitationEmailer', 'Mailer that sends any survey invitations that have been scheduled.', 'DISABLED', 30, 7200, NULL, 'NOT YET RUN', 0);
